...
template<typename T>
constexpr inline auto MAX_VALUE = T::MAX_VALUE;
template<typename T>
constexpr inline auto MIN_VALUE = T::MIN_VALUE;

template<>
constexpr inline auto MAX_VALUE<int8_t> = 127;
template<>
constexpr inline auto MIN_VALUE<int8_t> = -128;
template<>
constexpr inline auto MAX_VALUE<uint8_t> = 255;
template<>
constexpr inline auto MIN_VALUE<uint8_t> = 0;

template<>
constexpr inline auto MAX_VALUE<int16_t> = 32767;
template<>
constexpr inline auto MIN_VALUE<int16_t> = -32768;
template<>
constexpr inline auto MAX_VALUE<uint16_t> = 65535;
template<>
constexpr inline auto MIN_VALUE<uint16_t> = 0;

template<>
constexpr inline auto MAX_VALUE<int32_t> = int32_t((1ULL << 31ULL) - 1ULL);
template<>
constexpr inline auto MIN_VALUE<int32_t> = int32_t(-(1ULL << 31ULL));
template<>
constexpr inline auto MAX_VALUE<uint32_t> = uint32_t((1ULL << 32ULL) - 1ULL);
template<>
constexpr inline auto MIN_VALUE<uint32_t> = 0;

template<>
constexpr inline auto MAX_VALUE<int64_t> = int64_t((1ULL << 63ULL) - 1ULL);
template<>
constexpr inline auto MIN_VALUE<int64_t> = int64_t(-(1ULL << 63ULL));
template<>
constexpr inline auto MAX_VALUE<uint64_t> = uint64_t(18446744073709551615ULL);
template<>
constexpr inline auto MIN_VALUE<uint64_t> = 0;
